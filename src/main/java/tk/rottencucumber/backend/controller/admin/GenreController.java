...
public class GenreController {
    ...
    public List<SimpleRecord> getAll() {
        ...
        return SimpleRecordTool.createByGenreRecordList(all);
    }
    ...
    public ObjectResponse get(@PathVariable String slug) {
        ...
        return new ObjectResponse(true, String.format("Successfully get genre %s", model.getName()), List.of(SimpleRecordTool.createRecord(model)));
    }
}
